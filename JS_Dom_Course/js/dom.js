...
// itemInput.addEventListener('focus', runEvent); //focus means when you click inside of an input
// itemInput.addEventListener('blur', runEvent);
//blur means when you click out of the input

// itemInput.addEventListener('cut', runEvent);
// itemInput.addEventListener('paste', runEvent);

// itemInput.addEventListener('input', runEvent); //This event runs when we do anything with input
